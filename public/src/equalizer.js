...
slider1.oninput = function(e) {
  ...
  let value = 2.25 * parseFloat(e.target.value)
...
slider5.oninput = function(e) {
  ...
  let value = 2.25 * parseFloat(e.target.value)
  bassEQ5.gain.setTargetAtTime(value, context.currentTime, .01)
...
slider11.oninput = function(e) {
  ...
  highEQ11.gain.setTargetAtTime(value, context.currentTime, .01)
...
slider12.oninput = function(e) {
  ...
  let value = 2.25 * parseFloat(e.target.value) 
  highEQ12.gain.setTargetAtTime(value, context.currentTime, .01)
...
slider13.oninput = function(e) {
  ...
  let value = 2.25 * parseFloat(e.target.value) 
  highEQ13.gain.setTargetAtTime(value, context.currentTime, .01)
...
slider14.oninput = function(e) {
  ...
  let value = 2.25 * parseFloat(e.target.value)  
  highEQ14.gain.setTargetAtTime(value, context.currentTime, .01)
...
slider15.oninput = function(e) {
  ...
  let value = 2.25 * parseFloat(e.target.value)
  highEQ15.gain.setTargetAtTime(value, context.currentTime, .01)
